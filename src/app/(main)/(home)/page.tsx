'use client';
import { filterOptionsPlantas, plants } from "@/utils/plantas";
...
export default function HomePage() {
    ...
    const [filtered, setFiltered] = useState(plants.filter(el => {
        if (search) {
    ...
    return (
        <div className="flex h-full mt-[-80px] pt-20">
            <SideBar filterOptions={filterOptionsPlantas} />
            <div className="flex-col p-8 gap-8 flex w-full overflow-y-scroll">
                ...
                <div className="flex items-center gap-4">
                    ...
                    }} className={cn("border-[1px] py-2 px-3 rounded text-[#A3A5A9]", orderSelected !== 'name' && 'text-white bg-[#69B578]')}>Dificuldade no cultivo</button>
                </div>
